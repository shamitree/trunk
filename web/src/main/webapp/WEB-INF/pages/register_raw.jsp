	...
	<div>
		...
		<form:form role="form" commandName="register" method="POST">
	                                    ...
	                                    Chair Person
	                                     ...
	                                     <div class="form-group">
	                                     	<label>Name</label>
	                                        <input class="form-control" id="chairPersonName" name="chairPersonName">
	                                    </div>
	                                    ...
	                                    <div class="form-group">
                                            ...
                                            <div class="radio">
                                                <label>
                                                    <input type="radio" name="chairPersonGender" id="chairPersonGender1" value="male" checked>Male
                                                </label>
                                            </div>
                                            <div class="radio">
                                                <label>
                                                    <input type="radio" name="chairPersonGender" id="chairPersonGender2" value="female">Female
                                                </label>
                                            </div>
                                        </div>
	                                    ...
	                                    <div class="form-group">
	                                        ...
	                                        <input class="form-control" id="chairPersonIdNumber" name="chairPersonIdNumber">
	                                    </div>
	                                    
	                                    <div class="form-group">
	                                     	<label>Contact Number</label>
	                                        <input class="form-control" id="chairPersonContactNumber" name="chairPersonContactNumber">
	                                    </div>
	                                    ...
	                                    Deputy chair Person
	                                     ...
	                                     <div class="form-group">
	                                     	<label>Name</label>
	                                        <input class="form-control" id="deputyChairPersonName" name="deputyChairPersonName">
	                                    </div>
	                                    ...
	                                    <div class="form-group">
                                            ...
                                            <div class="radio">
                                                <label>
                                                    <input type="radio" name="deputyChairPersonGender" id="deputyChairPersonGender1" value="male" checked>Male
                                                </label>
                                            </div>
                                            <div class="radio">
                                                <label>
                                                    <input type="radio" name="deputyChairPersonGender" id="deputyChairPersonGender2" value="female">Female
                                                </label>
                                            </div>
                                        </div>
	                                    ...
	                                    <div class="form-group">
	                                     	<label>Id number</label>
	                                        <input class="form-control" id="deputyChairPersonIdNumber" name="deputyChairPersonIdNumber">
	                                    </div>
	                                    
	                                    <div class="form-group">
	                                     	<label>Contact Number</label>
	                                        <input class="form-control" id="deputyChairPersonContactNumber" name="deputyChairPersonContactNumber">
	                                    </div>
	                                    ...
	                                    Secretary
	                                     ...
	                                     <div class="form-group">
	                                     	<label>Name</label>
	                                        <input class="form-control" id="secretaryName" name="secretaryName">
	                                    </div>
	                                    ...
	                                    <div class="form-group">
                                            ...
                                            <div class="radio">
                                                <label>
                                                    <input type="radio" name="secretaryGender" id="secretaryGender1" value="male" checked>Male
                                                </label>
                                            </div>
                                            <div class="radio">
                                                <label>
                                                    <input type="radio" name="secretaryGender" id="secretaryGender2" value="female">Female
                                                </label>
                                            </div>
                                        </div>
	                                    ...
	                                    <div class="form-group">
	                                     	<label>Id number</label>
	                                        <input class="form-control" id="secretaryIdNumber" name="secretaryIdNumber">
	                                    </div>
	                                    
	                                    <div class="form-group">
	                                     	<label>Contact Number</label>
	                                        <input class="form-control" id="secretaryContactNumber" name="secretaryContactNumber">
	                                    </div>
	                                    ...
	                                    Deputy Secretary
	                                     ...
	                                     <div class="form-group">
	                                     	<label>Name</label>
	                                        <input class="form-control" id="deputySecretaryName" name="deputySecretaryName">
	                                    </div>
	                                    ...
	                                    <div class="form-group">
                                            ...
                                            <div class="radio">
                                                <label>
                                                    <input type="radio" name="deputySecretaryGender" id="deputySecretaryGender1" value="male" checked>Male
                                                </label>
                                            </div>
                                            <div class="radio">
                                                <label>
                                                    <input type="radio" name="deputySecretaryGender" id="deputySecretaryGender2" value="female">Female
                                                </label>
                                            </div>
                                        </div>
	                                    ...
	                                    <div class="form-group">
	                                     	<label>Id number</label>
	                                        <input class="form-control" id="deputySecretaryIdNumber" name="deputySecretaryIdNumber">
	                                    </div>
	                                    
	                                    <div class="form-group">
	                                     	<label>Contact Number</label>
	                                        <input class="form-control" id="deputySecretaryContactNumber" name="deputySecretaryContactNumber">
	                                    </div>
	                                    ...
	                                    Treasurer
	                                     ...
	                                     <div class="form-group">
	                                     	<label>Name</label>
	                                        <input class="form-control" id="treasurerName" name="treasurerName">
	                                    </div>
	                                    ...
	                                    <div class="form-group">
                                            ...
                                            <div class="radio">
                                                <label>
                                                    <input type="radio" name="treasurerGender" id="treasurerGender1" value="male" checked>Male
                                                </label>
                                            </div>
                                            <div class="radio">
                                                <label>
                                                    <input type="radio" name="treasurerGender" id="treasurerGender2" value="female">Female
                                                </label>
                                            </div>
                                        </div>
	                                    ...
	                                    <div class="form-group">
	                                     	<label>Id number</label>
	                                        <input class="form-control" id="treasurerIdNumber" name="treasurerIdNumber">
	                                    </div>
	                                    
	                                    <div class="form-group">
	                                     	<label>Contact Number</label>
	                                        <input class="form-control" id="treasurerContactNumber" name="treasurerContactNumber">
	                                    </div>
